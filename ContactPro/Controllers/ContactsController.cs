...
namespace ContactPro.Controllers
{
    public class ContactsController : Controller
    {
        ...
        public async Task<IActionResult> Index(int categoryId, string? swalMessage = null)
        {
            ...
            // return the UserId and it's associated contacts and categories
        ...
        public async Task<IActionResult> Create()
        {
            ...
            // Viewdata dictionary data that can be accessed in the view later 
            // Converts Enum into regualr list
            ViewData["ProvinceList"] = new SelectList(Enum.GetValues(typeof(Province)).Cast<Province>().ToList());
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,BirthDate,Address1,Address2,District,Province,ZipCode,Email,PhoneNumber,ImageFile")] Contact contact, List<int> CategoryList)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["CategoryList"] = new MultiSelectList(await _addressBookService.GetUserCategoriesAsync(appUserId),
                                                           "Id",
                                                           "Name",
                                                           await _addressBookService.GetContactCategoryIdsAsync(contact.Id));
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,AppUserId,FirstName,LastName,BirthDate,Address1,Address2,District,Province,ZipCode,Email,PhoneNumber,Created,ImageFile,ImageData,ImageType")] Contact contact, List<int> CategoryList)
        {
            if (id != contact.Id)
            {
                return NotFound();
